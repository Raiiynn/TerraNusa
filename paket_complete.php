<?php
session_start();
$pageTitle = "Complete Yogyakarta";
$package_id = 7; // Sesuaikan dengan ID paket di database
$package_name = "Paket Complete Yogyakarta";
    ...
    <div class="space-y-4">
        ...
        <div class="bg-tertiary/20 p-4 rounded-lg">
            <div class="flex justify-between items-center text-lg font-semibold">
                ...
                <input type="hidden" name="total_amount" id="totalAmountInput" value="3500000">
            </div>
        </div>
